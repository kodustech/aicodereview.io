...
One tool built explicitly around these standards is [Kodus](https://kodus.io), an open-source (AGPLv3) reviewer that is self-hostable, BYOK, and configured with plain-text team rules. Treat that as a starting point, not a recommendation: the rubric is the point. Run the protocol, and let your own numbers pick the tool.
